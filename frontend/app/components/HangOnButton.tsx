interface Props {
  onHangOn: (data: boolean) => void;
}

export default function HangOnButton({ onHangOn }: Props) {
  return (
    <button
      className="flex justify-center items-center w-26.25 rounded-2xl bg-red-500 cursor-pointer hover:bg-red-700 transition"
      onClick={() => onHangOn(false)}
    >
      <svg

export default function HangOnButton() {
  return (
    <div className="flex justify-center items-center w-26.25 rounded-2xl bg-red-500 cursor-pointer hover:bg-red-700 transition">
      <svg

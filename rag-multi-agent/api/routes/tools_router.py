...
async def register_tool(tool_req: ToolRegistrationRequest):
    try:
        with _write_lock:
            ...
            new_tool_config = {"tool_name": tool_req.tool_name, "description": tool_req.description,
                "api_url": tool_req.api_url, "http_method": tool_req.http_method,
        ...
        return {"status": "success", "message": f"Tool '{tool_req.tool_name}' registered successfully.",

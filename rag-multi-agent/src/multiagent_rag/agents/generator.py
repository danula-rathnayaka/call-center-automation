...
class Generator:
    def __init__(self):
        ...
        template_text = get_prompt_template("rag_prompt", "rag_prompt.txt")
    ...
    def generate(self, query: str, context: str, history: List[BaseMessage], summary: Optional[str] = None) -> str:
        try:
            ...
            response = self._invoke_with_retry({"context": context, "question": query, "chat_history": augmented_history})

...
class Guardrail:
    ...
    def validate(self, query: str) -> Dict[str, Any]:
        if not query or not query.strip():
            return {"safe": False, "reason": "I didn't catch that. Could you please repeat your question?",
                    "block_type": "empty", }

        if len(query) > 2000:
            return {"safe": False, "reason": "Your message is too long. Could you please keep it shorter?",
                    "block_type": "length", }
